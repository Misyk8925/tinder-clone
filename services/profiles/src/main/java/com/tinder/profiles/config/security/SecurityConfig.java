...
public class SecurityConfig {
    ...
    public SecurityFilterChain internalSecurityFilterChain(HttpSecurity http) throws Exception {
        // Match requests to /internal/** path prefix. Use the request URI rather than
        // the servlet path: the URI is populated identically in Tomcat and MockMvc,
        // while the servlet path is empty in MockMvc and would leak internal requests
