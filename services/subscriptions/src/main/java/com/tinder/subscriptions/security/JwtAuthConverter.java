...
/**
 * Converts JWT token to Spring Security AbstractAuthenticationToken,
 * extracting both realm_access and resource_access roles from Keycloak JWT.
 */
    ...
    private Collection<? extends GrantedAuthority> extractResourceRoles(Jwt jwt) {
        ...
        if (resourceAccess != null && resourceAccess.get("account") != null) {
            ...
            if (account.containsKey("roles")) {
                allRoles.addAll((Collection<String>) account.get("roles"));
            }
        }
