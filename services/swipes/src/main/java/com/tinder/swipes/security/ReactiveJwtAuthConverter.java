...
/**
 * Reactive JWT authentication converter for WebFlux applications.
 * Converts JWT to authentication token with roles from Keycloak.
 */
public final class ReactiveJwtAuthConverter implements Converter<Jwt, Mono<AbstractAuthenticationToken>> {
